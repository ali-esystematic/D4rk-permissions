...
```
\D4rk\Permission\Events\RoleAttached::class
\D4rk\Permission\Events\RoleDetached::class
\D4rk\Permission\Events\PermissionAttached::class
\D4rk\Permission\Events\PermissionDetached::class
```
